...
async function main(callSPLTokenProgramContractAddress = null) {
    ...
    console.log("\n\u{231B}", "\x1b[33m Testing on-chain formatting and execution of Solana's SPL Token program's \x1b[36minitializeMint2\x1b[33m instruction\x1b[0m")
    ...
    console.log('\nCalling callSPLTokenProgram.createInitializeTokenMint: ')

    let tx = await callSPLTokenProgram.connect(deployer).createInitializeTokenMint(
    ...
    console.log('\n' + ethers.encodeBase58(tokenMintInBytes), '<-- token mint\n')
