...
/// @title LibDataConverter
/// @author https://twitter.com/mnedelchev_
/// @notice This contract serves as a helper library for data conversion
library LibDataConverter {
    ...
    function toLittleEndianUnsigned32(uint32 input) internal pure returns (uint32) {
        // swap bytes
    ...
    function toLittleEndianSigned32(uint32 input) internal pure returns (int32) {
        input = ((input << 8) & 0xFF00FF00) | ((input >> 8) & 0x00FF00FF);
        return int32((input << 16) | ((input >> 16) & 0xFFFF));
    }

    function toLittleEndianUnsigned64(uint64 input) internal pure returns (uint64) {
        // swap bytes
    ...
    function toLittleEndianSigned64(uint64 input) internal pure returns (int64) {
        // swap bytes
    ...
    function toLittleEndianUnsigned128(uint128 input) internal pure returns (uint128) {
        // swap bytes
    ...
    function toLittleEndianSigned128(uint128 input) internal pure returns (int128) {
        // swap bytes
        input = ((input << 8) & 0xFF00FF00FF00FF00FF00FF00FF00FF00) |
            ((input >> 8) & 0x00FF00FF00FF00FF00FF00FF00FF00FF);
        // swap 2-byte long pairs
        input = ((input << 16) & 0xFFFF0000FFFF0000FFFF0000FFFF0000) |
            ((input >> 16) & 0x0000FFFF0000FFFF0000FFFF0000FFFF);
        // swap 4-byte long pairs
        input = ((input << 32) & 0xFFFFFFFF00000000FFFFFFFF00000000) |
            ((input >> 32) & 0x00000000FFFFFFFF00000000FFFFFFFF);
        // swap 8-byte long pairs
        return int128((input << 64) | ((input >> 64) & 0xFFFFFFFFFFFFFFFF));
    }

    function toLittleEndianUnsigned256(uint256 input) internal pure returns (uint256) {
        // swap bytes
    ...
    function toLittleEndianSigned256(uint256 input) internal pure returns (int256) {
        // swap bytes
        input = ((input << 8) & 0xFF00FF00FF00FF00FF00FF00FF00FF00) |
            ((input >> 8) & 0x00FF00FF00FF00FF00FF00FF00FF00FF);
        // swap 2-byte long pairs
        ...
        input = ((input << 32) & 0xFFFFFFFF00000000FFFFFFFF00000000) |
            ((input >> 32) & 0x00000000FFFFFFFF00000000FFFFFFFF);
        // swap 8-byte long pairs
        input = ((input << 64) & 0xFFFFFFFFFFFFFFFF0000000000000000FFFFFFFFFFFFFFFF0000000000000000) |
            ((input >> 64) & 0x0000000000000000FFFFFFFFFFFFFFFF0000000000000000FFFFFFFFFFFFFFFF);
        // swap 16-byte long pairs
