...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface LibRaydiumErrorsInterface extends Interface {
  ...
  export interface LibRaydiumErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibRaydiumErrors;
    waitForDeployment(): Promise<this>;

    interface: LibRaydiumErrorsInterface;
