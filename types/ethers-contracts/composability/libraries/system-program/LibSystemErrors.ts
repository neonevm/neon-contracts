...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface LibSystemErrorsInterface extends Interface {
  ...
  export interface LibSystemErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibSystemErrors;
    waitForDeployment(): Promise<this>;

    interface: LibSystemErrorsInterface;
